...
#./snap.py -ef ../config/etcdConfig.yml -cf ../config/dsa.yaml -hs 10.41.0.190 -df ../config/beamformer_weights.yaml -n 21 &
#./snap.py -ef ../config/etcdConfig.yml -cf ../config/dsa.yaml -hs 10.41.0.142 -df ../config/beamformer_weights.yaml -n 22 &
