...
while true; do
    ...
    ./get_spec.py -cf ../config/dsa.yaml -hs 10.41.0.186 -f /home/ubuntu/data/snap9.npz -a 103 -b 12 -c 11
    ...
    ./get_spec.py -cf ../config/dsa.yaml -hs 10.41.0.240 -f /home/ubuntu/data/snap13.npz -a 1 -b 104 -c 105
    ./get_spec.py -cf ../config/dsa.yaml -hs 10.41.0.242 -f /home/ubuntu/data/snap14.npz -a 106 -b 107 -c 108
    ./get_spec.py -cf ../config/dsa.yaml -hs 10.41.0.152 -f /home/ubuntu/data/snap15.npz -a 109 -b 110 -c 111
