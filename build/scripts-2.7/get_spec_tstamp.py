...
def run(args):
    ...
    t = time.gmtime()
    att = str(t.tm_year)+'_'+str(t.tm_mon)+'_'+str(t.tm_mday)+'_'+str(t.tm_hour)+'_'+str(t.tm_min)+'_'+str(t.tm_sec)

    np.savez(args.fname+'_'+att+'.npz',a1=args.a1,a2=args.a2,a3=args.a3,specs=(s1,s2,s3,s4,s5,s6),time=tt,tstring=att)
